...
const postCard = ({ post }) => {
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-12'>
      ...
      <div className='block lg:flex text-center items-center justify-center mb-8 w-full'>
        <div className='flex justify-center items-center mb-4 lg:mb-0 w-full lg:w-auto mr-8'>
          <img
            ...
            width='30px'
          />
          <p className='ml-2 inline align-middle text-gray-700 font-medium text-lg '>{ post.author.name }</p>
        </div>
        <div className='font-medium text-gary-700'>
